//once a 'weapon' is chosen, highlight choice and dim other choices
...
// choices.forEach(choice => choice.addEventListener('click', battleActive));
// choices.forEach(choice => choice.addEventListener('click', lockChoice));
...
function selectWeapon() {
  ...
  //checks if the newly clicked weapon is the same as the previous one and just removes the 'selected' class
  ...
  // console.log("YOU HAVE CHOSEN: " + weaponType);
}
